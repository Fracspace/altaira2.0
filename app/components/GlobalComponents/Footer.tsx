            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr_1fr] gap-10">
                    <div className="flex flex-col gap-5">
                        <Link href="/">
                            <Image src={AltairaLogo1} alt="altaira logo" className="md:w-[20vw] md:h-[10vh] lg:w-[20vw] xl:w-[10vw] lg:h-[10vh] h-[10vh] w-[40vw]" />
                        </Link>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <ul className="flex flex-col gap-3 text-base">
                            ...
                            <Link href="/timeline" className={linkClasses}>Timeline</Link>
                             <Link href="/faq" className={linkClasses}>Faq's</Link>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <ul className="flex flex-col gap-3 cursor-pointer">
                            ...
                            <li className={contactClasses}><a href="tel:+919880626111">Phone: +91 9880626111,<br/> +94-76031 2345</a></li>
