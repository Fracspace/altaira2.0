...
type InvestmentBudget = | "$100,000 - $250,000" | "$250,000 - $500,000" | "$500,000+";
...
const InvestmentForm = () => {
    ...
    const [isSubmittedInvestmentForm, setSubmittedInvestmentForm] = useState(false);
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex flex-row gap-3">
                        <div className="flex flex-col md:w-[50vw] lg:w-[25vw] gap-2">
                            ...
                            <input name="firstName" type="text" id="firstName" value={formData.firstName} onChange={handleInputChange} placeholder="First Name*" required className="w-full px-4 py-2 rounded-md border border-gray-300 placeholder:text-[rgba(0,0,0,0.5)] dark:text-black dark:bg-white dark:placeholder-black" />
                        </div>
                        <div className="flex flex-col md:w-[50vw] lg:w-[25vw] gap-2">
                            <label htmlFor="lastName">Last Name</label>
                            <input name="lastName" type="text" id="lastName" value={formData.lastName} onChange={handleInputChange} placeholder="Last Name*" required className="w-full px-4 py-2 rounded-md border border-gray-300 placeholder:text-[rgba(0,0,0,0.5)] dark:text-black dark:bg-white dark:placeholder-black" />
                        </div>
                    </div>
                    <div className="flex flex-col w-full gap-2">
                        <label htmlFor="emailId">Email ID</label>
                        <input name="emailId" type="email" id="emailId" value={formData.emailId} onChange={handleInputChange} placeholder="Email Id*" required className="w-full px-4 py-2 rounded-md border border-gray-300 placeholder:text-[rgba(0,0,0,0.5)] dark:text-black dark:bg-white dark:placeholder-black" />
                    </div>
                    <div className="flex flex-col w-full gap-2">
                    ...
                    <Select<{ label: string; value: InvestmentBudget }>
                        ...
                        required
                        value={budgetRanges.find((opt) => opt.value === formData.investmentBudget)}
                        onChange={(option) =>
                            setFormData((prev) => ({
                                ...prev,
                        ...
                        styles={{
                            placeholder: (base) => ({ ...base, color: "black" }), input: (base) => ({
                                ...base,
                                color: "black"
                            }),
                            menu: (base) => ({
                    ...
                    <div className="flex flex-col w-full gap-2">
                        ...
                        <textarea name="message" rows={4} cols={10} id="message" value={formData.message} onChange={handleInputChange} placeholder="Tell us about your interest in Altaira..." className="border border-gray-400 placeholder:text-[rgba(0,0,0,0.5)] dark:text-black dark:bg-white dark:placeholder-black rounded-md p-3"></textarea>
                    </div>
                    {isSubmittedInvestmentForm && (
                        <div className='mt-4'>
                            Thank you for reaching out! We've received your inquiry and our team is already on it.
                        </div>
                    )}
