...
function ElevatedArrival() {
  ...
  return (
    <section>
      <div ref={containerRef} className="flex flex-col md:flex-row ml-[5vw] mr-[5vw] mt-6">
        <div>
          <Image
            src={helipadImg}
            alt="helipad image"
            className="w-full object-cover md:w-[50vw] h-[60vh]"
          />
        </div>
        <div className="mt-12">
      ...
      <div className="mt-12 mb-12 flex items-center justify-center">
        <h2
          ref={contentRef}
          className="w-full md:w-[60vw] text-[#67777E] text-center text-6xl font-cormorant"
        >
