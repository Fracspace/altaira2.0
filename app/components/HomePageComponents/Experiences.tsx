...
function Experiences() {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden relative">
      <div>
        <h2 className="font-cormorant text-3xl md:text-5xl text-center mt-12">
          A World of Experiences, Shaped by the Land
        </h2>
        <h3 className="font-inter ml-[2vw] mr-[2vw] md:text-lg 2xl:text-xl md:w-[80vw] mt-6 mb-4 text-center md:ml-[9vw] md:mr-[9vw]">
      ...
      <div className="flex flex-col md:flex-row overflow-hidden relative group ml-[5vw] mr-[5vw] mr-15 mt-6">
        <div
          ref={adventureZoneRef}
          style={{ backgroundImage: `url(${bunjeeImg.src})` }}
          className="relative w-[90vw] h-[40vh] md:w-[45vw] md:h-[82vh] bg-center bg-cover"
        >
        ...
        <div className="mt-[2vh] md:mt-0 md:ml-4">
          <div
            ref={cloudwalkwayRef}
            style={{ backgroundImage: `url(${cloudwalkwayImg.src})` }}
            className="relative w-[90vw] h-[40vh] md:w-[45vw] md:h-[40vh] bg-center bg-cover "
          >
            <div className="absolute inset-0 bg-black/30"></div>
            <div className="absolute bottom-0 ml-3 mb-2 z-10">
              <h3 className="text-white font-inter">
          ...
          <div
            ...
            className="relative w-[90vw] h-[40vh] md:w-[45vw] md:h-[40vh] bg-center bg-cover mt-3"
          >
            <div className="absolute inset-0 bg-black/30"></div>
