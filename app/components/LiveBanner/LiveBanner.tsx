...
const LiveBanner = () => {
    ...
    const apiUrl = "https://apitest.fracspace.com/api/altaira/promo/ui/getCarouselUi"

    useEffect(() => {
        async function fetchLaunchDate(apiUrl: string): Promise<void> {  //not returning anything (void)
            try {
            ...
            isLive ? (
                ...
                >
                    ...
                    <span className="ml-2 font-semibold text-sm">
                        Altaira Soft Launch is Live. Click to Watch.
                    </span>
                </div>
            ) : (
