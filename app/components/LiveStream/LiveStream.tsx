...
const LiveStream = ({ src, endTime, enabled }: LiveStreamProps) => {
            ...
            <div className="ml-10 mt-5">
                <Link href="/">
                    <Image
                        src={AltairaLogo}
                        alt="logo"
                        className="w-[40vw] h-[10vh] md:w-[20vw] md:h-[10vh] lg:w-[20vw] lg:h-[10vh] xl:w-[10vw]"
                    />
                </Link>
            </div>
            <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
                <div className="w-full md:w-auto max-w-7xl">
