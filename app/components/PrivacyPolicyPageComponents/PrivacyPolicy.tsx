        ...
        <div className='min-h-screen'>
            <div className="max-w-7xl mx-auto md:pt-10">
                <div className='flex flex-col gap-5 ml-10 mr-10 py-10'>
                    <h2 className='font-cormorant text-center text-3xl lg:text-4xl pt-20'>Privacy Policy</h2>
                    <h2 className='font-inter text-lg'><span className='font-bold'>Last Updated:</span> December 2025</h2>
                    <p className='font-inter text-base leading-relaxed '>We are committed to protecting your personal information and respecting your privacy. This Privacy Policy explains how we collect, use, store, share, and protect your data when you interact with the Altaira website, booking forms, marketing campaigns, or support channels.</p>
                    <div className="flex flex-col gap-8">
                        <ol className="pl-5 space-y-10">

                            {/* 1 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">1. Information We Collect</span>
                            ...
                            {/* 2 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">2. How We Collect Information</span>
                                <div className="mt-4">
                                    <span className="font-normal">We collect information through:</span>
                                </div>
                            ...
                            {/* 3 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">3. Purpose of Data Collection</span>
                                <div className="mt-4">
                                    <span className="font-normal">We use your information to:</span>
                                </div>
                                <ul className="list-disc pl-5 space-y-2 mt-4 font-normal">
                            ...
                            {/* 4 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">4. Sharing of Information</span>
                                <div className="mt-4">
                                    <span className="font-normal">We may share the data with:</span>
                                </div>
                                <ul className="list-disc pl-5 space-y-2 mt-4 font-normal">
                            ...
                            {/* 5 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">5. Data Retention</span>
                                <div className="mt-4">
                                    <span className="font-normal">We retain your data for as long as necessary to:</span>
                                </div>
                                <ul className="list-disc pl-5 space-y-2 mt-4 font-normal">
                            ...
                            {/* 6 */}
                            <li className="font-semibold">
                                <span className="text-3xl mt-4 font-normal text-gray-600 dark:text-white">6. Your Rights</span>
                                <div className="mt-4">
                                    <span className=" font-normal">Subject to law, you may request:</span>
                                </div>
                            ...
                            {/* 7 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">7. Data Security</span>
                            ...
                            {/* 8 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">8. Cookies</span>
                                <ul className="list-disc pl-5 space-y-2 mt-4 font-normal">
                            ...
                            {/* 9 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">9. International Users</span>
                                <p className="mt-4 font-normal leading-relaxed">
                            ...
                            {/* 10 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">10. Changes to This Policy</span>
                                <p className="mt-4 font-normal">
                            ...
                            {/* 11 */}
                            <li className="font-semibold">
                                <span className="text-3xl font-normal text-gray-600 dark:text-white">11. Contact Us</span>
                                <p className="mt-4 font-normal">For privacy or data-related concerns, please contact:</p>
