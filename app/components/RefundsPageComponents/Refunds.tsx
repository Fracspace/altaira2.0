        ...
        <div className='min-h-screen'>
            <div className="max-w-7xl mx-auto md:pt-10">
                <div className='flex flex-col gap-5 ml-10 mr-10 py-10'>
                    <h2 className='font-cormorant text-center text-3xl lg:text-4xl pt-20'>Refund & Cancellation Policy</h2>
                    <h2 className='font-inter text-lg'><span className='font-bold'>Last Updated:</span> December 2025</h2>
                    <p className='font-inter text-base leading-relaxed'>This Refund & Cancellation Policy applies to all online and offline bookings, enquiries, and payments made towards the Altaira Project.</p>
                    ...
                    <div className="text-gray-600 dark:text-white flex flex-col gap-5">
                        ...
                        <p className='font-inter text-base leading-relaxed'>2.1 All bookings are provisional until accepted in writing by the Developer.</p>
                        <p className='font-inter text-base leading-relaxed'>2.2 Booking Amounts are generally non-refundable, except as expressly provided below.</p>
                        <p className='font-inter text-base leading-relaxed'>2.3 Refunds, where applicable, shall be processed only to the original payer's bank account.</p>
                    </div>
                        ...
                        <ul className="list-disc md:pl-10">
                            <li className="font-bold">
                                ...
                                <ul className="list-disc ml-6 mt-1 font-normal">
                                    <li>Refund of Booking Amount minus bank/payment gateway charges.</li>
                                </ul>
                            </li>

                            <li className="font-bold">Cancellation after 7 days but before 30 days: <ul className="list-disc ml-6 mt-1 font-normal"><li>Up to 15-25% of the Booking Amount may be deducted as an administrative fee.</li></ul> </li>
                            <li className="font-bold">Cancellation after 30 days but before Agreement. <ul className="list-disc ml-6 mt-1 font-normal"><li>Up to 50% of the Booking Amount may be forfeited.</li></ul></li>
                        </ul>
                        <p className="font-inter text-lg font-medium leading-relaxed">B. AFTER EXECUTION OF THE MAIN AGREEMENT</p>

                        <ul className="list-disc md:pl-10">
                            <li>Refunds or cancellations will be governed solely by the Agreement,</li>
                            <li>Booking Amount becomes non-refundable,</li>
                            <li>Any exit will depend on resale, transfer rules, and applicable fees stated in the Agreement.</li>
                        </ul>
                    </div>
                    ...
                    <div className="text-gray-600 dark:text-white flex flex-col gap-5">
                        ...
                        <p className="font-inter text-base leading-relaxed">Eligible refunds will be processed within <span className="font-bold">30-60 working days</span> from the date all required documentation is submitted and approved.</p>
                    </div>
