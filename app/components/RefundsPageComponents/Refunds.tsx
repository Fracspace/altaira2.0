      ...
      <div className="max-w-7xl mx-auto md:pt-10">
        <div className="flex flex-col gap-5 ml-10 mr-10 py-10">
          ...
          <p className="font-inter text-base leading-relaxed">
            This Refund & Cancellation Policy applies to all online and offline
            bookings, enquiries, and payments made towards the Altaira Project.
          </p>
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <ul className="list-disc md:pl-10">
              <li>
                <b>Booking Amount / Token</b> - A preliminary payment made to
                reserve interest in a unit or fractional share.
              </li>
              <li>
                <b>Agreement</b> - The legally binding purchase or participation
                agreement executed between the Customer and the Developer.
              </li>
              <li>
                <b>Customer</b> - Any individual or entity making a booking or
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <p className="font-inter text-base leading-relaxed">
              2.1 All bookings are provisional until accepted in writing by the
              Developer.
            </p>
            <p className="font-inter text-base leading-relaxed">
              2.2 Booking Amounts are generally non-refundable, except as
              expressly provided below.
            </p>
            <p className="font-inter text-base leading-relaxed">
              2.3 Refunds, where applicable, shall be processed only to the
              original payer's bank account.
            </p>
          </div>

          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            <h2 className="text-3xl">3. Customer-Initiated Cancellation</h2>
            <p className="font-inter text-lg font-medium leading-relaxed">
            ...
            <ul className="list-disc md:pl-10">
              ...
              <li className="font-bold">
                ...
                <ul className="list-disc ml-6 mt-1 font-normal">
                  <li>
                    Up to 15-25% of the Booking Amount may be deducted as an
                    administrative fee.
                  </li>
                </ul>{" "}
              </li>
              <li className="font-bold">
                ...
                <ul className="list-disc ml-6 mt-1 font-normal">
                  <li>Up to 50% of the Booking Amount may be forfeited.</li>
                </ul>
              </li>
            </ul>
            <p className="font-inter text-lg font-medium leading-relaxed">
            ...
            <ul className="list-disc md:pl-10">
              <li>
                Refunds or cancellations will be governed solely by the
                Agreement,
              </li>
              <li>Booking Amount becomes non-refundable,</li>
              <li>
                Any exit will depend on resale, transfer rules, and applicable
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <p>
              Refunds (if any) will be issued after deducting administrative
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <p className="font-inter text-base leading-relaxed">
              ...
              <span className="font-bold">30-60 working days</span> from the
              date all required documentation is submitted and approved.
            </p>
          </div>
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <ul className="list-disc md:pl-10">
              <li>
                For payments made in a foreign currency, refund amounts may vary
                due to exchange rate fluctuations, intermediary banking fees, or
                conversion charges.
              </li>
              <li>The Customer bears all such charges.</li>
              <li>
                The Developer’s obligation is limited to refunding the net
                amount actually received in its account.
              </li>
            </ul>
          </div>
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <ul className="list-disc md:pl-10">
              <li>
                ...
                <span className="text-gray-500">altaira.lk@fracspace.com</span>{" "}
                with proof of transaction.
              </li>
              <li>
          ...
          <div className="text-gray-600 dark:text-white flex flex-col gap-5">
            ...
            <ul className="list-disc md:pl-10">
              <li>
                Convenience fees, processing charges, bank fees, and payment
                gateway fees.
              </li>
              <li>
                Any optional add-ons, service fees, or administrative fees
                already incurred.
              </li>
