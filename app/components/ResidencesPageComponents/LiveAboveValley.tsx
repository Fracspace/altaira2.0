...
const LiveAboveValley = () => {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo(liveAboveValleyRef.current,
            { opacity: 0, y: 60 }, {
        ...
        <div ref={liveAboveValleyRef}>
            <div>
                <div className="flex p-10 flex-col gap-2">
                    <h2 className="text-center font-cormorant font-bold text-3xl md:text-4xl">Live Above the Valley</h2>
                    <p className="text-center leading-relaxed para">A limited collection of private villas set along the ridge - designed for ownership, privacy, and uninterrupted views. Altaira Private Residences are not standalone homes. They are fully integrated into a luxury hilltop resort ecosystem - combining the calm of private living with the privileges of a destination retreat.</p>
                </div>
                ...
                <div ref={privateResidencesRef} className="flex p-10 flex-col md:flex-row gap-5">
                    <div className="flex flex-col gap-5 md:w-[50vw] residences-content">
                        ...
                        <i className="font-bold text-[#AD9273]">Life here unfolds at a slower rhythm.</i>
                        <div className="flex items-center gap-5 feature-item">
                            <div className="w-1 h-12 rounded bg-[#AD9273]"></div>
                            <div className="flex flex-col">
                                <h2 className="font-cormorant text-xl md:text-2xl">Valley-Facing Plunge Pool</h2>
                                <p className="para">Positioned for privacy, sky views, and quiet moments</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-5 feature-item">
                            <div className="w-1 h-12 rounded bg-[#AD9273]"></div>
                            <div className="flex flex-col">
                                <h2 className="font-cormorant text-xl md:text-2xl">3,600 sq. ft. Living Space</h2>
                                <p className="para">Open, flowing interiors designed around light and air</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-5 feature-item">
                            <div className="w-1 h-12 rounded bg-[#AD9273]"></div>
                            <div className="flex flex-col">
                                <h2 className="font-cormorant text-xl md:text-2xl">2 Dedicated Car Parks</h2>
                                <p className="para">Secure, reserved parking for each residence</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-5 feature-item">
                            <div className="w-1 h-12 rounded bg-[#AD9273]"></div>
                            <div className="flex flex-col">
                                <h2 className="font-cormorant text-xl md:text-2xl">Entrance Courtyard</h2>
                                <p className="para">A private arrival that brings nature into the home</p>
                            </div>
                        </div>
                    </div>
