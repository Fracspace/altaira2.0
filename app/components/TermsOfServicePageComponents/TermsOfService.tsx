        ...
        <div className='min-h-screen'>
            <div className="max-w-7xl mx-auto md:pt-10">
                <div className='flex flex-col gap-5 ml-10 mr-10 py-10'>
                    <h2 className='font-cormorant text-center text-3xl lg:text-4xl pt-20'>Terms and Conditions</h2>
                    <h2 className='font-inter text-lg'><span className='font-semibold'>Last Updated:</span> December 2025</h2>
                    <p className='font-inter text-gray-600 text-base leading-relaxed dark:text-white '>Welcome to the official website of <b>Altaira – Above The Clouds</b> (“Altaira”, “Project”, “We”, “Us”, “Our”). By accessing, browsing, filling forms, downloading material, or making any transaction on this website (“Site”), you (“User”, “Customer”, “Visitor”) agree to be bound by the following Terms & Conditions. If you do not agree to these Terms, please discontinue use of the Site.</p>
                    ...
                    <div className="text-gray-600 dark:text-white flex flex-col gap-5">
                        ...
                        <p className="font-inter text-base leading-relaxed">These Terms are governed by the laws of <span className="font-bold">[Sri Lanka]</span>. Any disputes shall be subject to the exclusive jurisdiction of the courts located in <span className="font-bold">[Colombo/Sri Lanka]</span>, unless otherwise mandated by governing agreements.</p>
                    </div>
                </div>
            </div>
        </div>
