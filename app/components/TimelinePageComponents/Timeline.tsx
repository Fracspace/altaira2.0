...
import BrochureDownload from "../ResidencesPageComponents/BrochureDownload";
...
const Timeline = () => {
  ...
  const scrollToMonth = (month: string) => {
    ...
    setTimeout(() => {
      monthsRef.current[key]?.scrollIntoView({
        behavior: "smooth",
        block: "center"
      });
    }, 200);
  ...
  return (
    <div className="py-10 ml-10 mr-10">
      <div className="max-w-7xl mx-auto">
        <div
          ref={timelineRef}
          className="flex flex-col items-center max-w-5xl mx-auto text-center justify-center gap-5"
        >
          <h2 className="font-inter text-[#AD9273] text-lg xl:text-xl">
            DEVELOPMENT JOURNEY
          </h2>
          <p className="font-cormorant text-3xl md:text-4xl xl:text-5xl">
            Crafting a Destination in the Clouds
          </p>
          <p className="font-inter text-lg text-gray-500 dark:text-white max-w-4xl xl:text-xl">
            Milestones in creating a destination above the clouds, shaped with
            intention and built to offer a life where nature and comfort exist
            in perfect balance. From concept to completion, Altaira is being
            built with care, precision, and a vision to redefine mountain
            living.
          </p>
        </div>
      ...
      transition-all duration-300 cursor-pointer"
        ...
        <div>
          <ul className="relative mt-10 max-w-6xl mx-auto">
            ...
            <li
              ref={(el) => {
                monthsRef.current["2026-January"] = el;
              }}
              className="relative grid-cols-1 md:grid grid-cols-2 gap-20 pb-5 md:pb-16"
            >
              ...
              <div className="flex flex-col p-5 rounded-md border border-[#AD9273]/60 gap-3">
                <p className="font-inter rounded-full bg-[#C6A66799] w-fit px-2 py-1 xl:text-xl text-white">
                  Oct 2025
                </p>
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  Land Acquisition Complete
                </h4>
                <p className="text-gray-500 dark:text-white xl:text-lg font-inter">
                  The hilltop site for Altaira was officially acquired, marking
                  the foundation of the project. This secured the location,
                  views, and long-term vision for the destination.
                </p>
            ...
            {isOpen && selectedMonth === "Jan" && (
              <ModalMonth title={selectedMonth!} onClose={closeModal} />
            )}
            <li
              ref={(el) => {
                monthsRef.current["2026-February"] = el;
              }}
              className="relative grid grid-cols-1 md:grid-cols-2 pb-5 md:gap-20 md:pb-16"
            >
              <div className="flex flex-col p-5 rounded-md border border-[#AD9273]/60 gap-3">
                <p className="font-inter rounded-full bg-[#C6A66799] xl:text-xl w-fit px-2 py-1 text-white">
                  Nov 2025
                </p>
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  Architects Engaged
                ...
                <p className="text-gray-500 dark:text-white font-inter text-lg">
                  Inside Project was onboarded as the lead architectural partner
                  to shape Altaira’s masterplan, ensuring a design approach
                  rooted in the landscape and long-term usability.
                </p>
            ...
            {isOpen && selectedMonth === "February" && (
              <ModalMonth title={selectedMonth!} onClose={closeModal} />
            )}
            <li
              ref={(el) => {
                monthsRef.current["2026-March"] = el;
              }}
              className="relative grid-cols-1 md:grid grid-cols-2 gap-20 pb-5 md:pb-16"
            >
              <div className="relative">
              ...
              <div className="flex flex-col rounded-md border border-[#AD9273]/60 p-5 gap-3">
                ...
                <p className="text-gray-500 dark:text-white xl:text-lg font-inter">
                  Applications were submitted to SLTDA and BOI, initiating the
                  formal approval process required for tourism and investment
            ...
            <li
              ref={(el) => {
                monthsRef.current["2026-April"] = el;
              }}
              className="relative grid grid-cols-1 md:grid-cols-2 pb-5 md:gap-20 md:pb-16"
            >
              <div className="flex flex-col rounded-md border border-[#AD9273]/60 p-5 gap-3">
                ...
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  SLTDA Site visit conducted
                </h4>
                <p className="font-normal xl:text-lg text-gray-500 dark:text-white font-inter">
                  The SLTDA team conducted an on-site visit to assess the land,
                  access, and development plans - a key step toward regulatory
                  clearance.
                </p>
                {/* <button className='text-left rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer'>Read More</button> */}
              </div>
            ...
            >
              ...
              <div className="flex flex-col rounded-md border border-[#AD9273]/60 p-5 gap-3">
                ...
                <p className="text-gray-500 dark:text-white xl:text-lg font-inter">
                  Altaira was officially unveiled on 14 February 2026, where the
                  vision, masterplan, and overall experience were introduced to
                  early partners, stakeholders, and prospective investors.
                </p>
                {/* <button className='text-left rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer'>Read More</button> */}
              </div>
              <span className="flex items-center justify-center absolute left-[-20] md:left-1/2 top-2 h-4 w-4 bg-[#C6A66799] rounded-full -translate-x-1/2 z-10">
            ...
            <li
              ref={(el) => {
                monthsRef.current["2026-June"] = el;
              }}
              className="relative grid grid-cols-1 md:grid-cols-2 pb-5 md:gap-20 md:pb-16"
            >
              <div className="flex flex-col rounded-md border border-[#AD9273] p-5 gap-3">
                ...
                <p className="xl:text-lg text-gray-500 dark:text-white font-inter">
                  Following a comprehensive review and site inspection, Altaira
                  has proudly secured Preliminary Clearance from the Sri Lanka
                  Tourism Development Authority (SLTDA). This important
                  government endorsement marks a key regulatory milestone and
                  significantly strengthens the project's credibility as we
                  advance toward the next phase of development.
                </p>
                <button
                  onClick={() => setOpenRegForm(true)}
                  className="text-left text-gray-500 rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer"
                >
            ...
            >
              ...
              <div className="flex flex-col rounded-md border border-[#AD9273]/60 p-5 gap-3">
                ...
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  Announcement of Altaira Luxury Yurts
                </h4>
                <p className="text-gray-500 dark:text-white xl:text-lg font-inter">
                  We announced Altaira’s luxury hilltop yurts, redefining how
                  premium living can be experienced and owned. Designed for both
                  fractional co-ownership and full ownership, this offering
                  gives individuals the flexibility to choose between shared
                  access or complete private ownership. Each yurt is fully
                  furnished, thoughtfully designed, and professionally managed
                  to deliver a seamless luxury experience.
                </p>
                {/* <button className='text-left rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer'>Read More</button> */}
              </div>
              <span className="flex items-center justify-center absolute left-[-20] md:left-1/2 top-2 h-4 w-4 bg-[#C6A66799] rounded-full -translate-x-1/2 z-10">
            ...
            >
              <div className="flex flex-col rounded-md border border-[#AD9273] p-5 gap-3">
                ...
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  Altaira Resort - Planned Completion: December 2027
                </h4>
                <p className="xl:text-lg text-gray-500 dark:text-white font-inter">
                  The core resort experience, including hospitality spaces,
                  dining, wellness areas, and shared amenities, is targeted for
                  completion by December 2027 - bringing the first phase of
                  Altaira to life.
                </p>
                {/* <button className='text-left rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer'>Read More</button> */}
              </div>
            ...
            <li
              ref={(el) => {
                monthsRef.current["2026-July"] = el;
              }}
              className="relative grid-cols-1 md:grid grid-cols-2 pb-5 md:gap-20 md:pb-16"
            >
              <div className="relative">
                <div className="w-full h-full overflow-hidden rounded-full">
                  <Image
              ...
              <div className="flex flex-col rounded-md border border-[#AD9273]/60 p-5 gap-3">
                ...
                <h4 className="text-xl md:text-2xl xl:text-3xl font-cormorant font-semibold">
                  Altaira Residences - Planned Completion: December 2028
                </h4>
                <p className="text-gray-500 dark:text-white xl:text-lg font-inter">
                  The private residences and villas are planned for completion
                  by December 2028, following the resort launch, ensuring a
                  well-paced and integrated development.
                </p>
                {/* <button className='text-left rounded-md px-6 py-2 hover:scale-105 transition-transform duration-150 ease-in-out hover:shadow-[0_0_8px_rgba(173,146,115,0.2)] hover:border-none border border-[#AD9273]/60 w-fit cursor-pointer'>Read More</button> */}
              </div>
              <span className=" absolute left-[-20] md:left-1/2 top-2 h-4 w-4 bg-[#BFC4BE] rounded-full -translate-x-1/2 z-10"></span>
