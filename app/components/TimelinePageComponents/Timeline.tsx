    ...
    return (
        <div className='p-10'>
            <div ref={timelineRef} className='flex flex-col items-center justify-center gap-5'>
                ...
                <p className='font-inter text-lg text-gray-500 max-w-4xl xl:text-xl font-normal'>
                ...
                <ul className="relative mt-10 max-w-6xl mx-auto">
                    ...
                    <li className="relative grid-cols-1 md:grid grid-cols-2 gap-20 pb-16">
                        ...
                        <div className='flex flex-col p-5 rounded-md border border-[#AD9273] gap-3'>
                            <p className='font-inter rounded-full bg-[#C6A66799] w-fit px-2 py-1 xl:text-xl text-white'>Q1 2026</p>
                    ...
                    <li className="relative grid grid-cols-1 md:grid-cols-2 gap-20 md:pb-16">
                        <div className="flex flex-col p-5 rounded-md border border-[#AD9273] gap-3">
                            <p className='font-inter rounded-full bg-[#C6A66799] xl:text-xl w-fit px-2 py-1 text-white'>Q2 2026</p>
                    ...
                    <li className="relative grid-cols-1 md:grid grid-cols-2 gap-20">
                        ...
                        <div className='flex flex-col rounded-md border border-[#AD9273] p-5 gap-3'>
                            <p className='font-inter rounded-full bg-[#C6A66799] xl:text-xl w-fit px-2 py-1 text-white'>Q3 2027</p>
                    ...
                    <li className="relative grid grid-cols-1 mt-10 md:grid-cols-2 gap-20 pb-16">
                        <div className="flex flex-col rounded-md border border-[#AD9273] p-5 gap-3">
                            <p className='font-inter rounded-full bg-[#C6A66799] xl:text-xl w-fit px-2 py-1 text-white'>Q4 2028</p>
